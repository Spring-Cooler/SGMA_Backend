package com.springcooler.sgma.submittedanswer.common.exception;
...
@RestControllerAdvice(basePackages = "com.springcooler.sgma.submittedanswer", name = "submittedAnswerRestControllerAdvice")
