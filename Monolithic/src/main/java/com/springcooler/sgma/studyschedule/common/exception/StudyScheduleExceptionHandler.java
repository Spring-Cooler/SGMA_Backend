package com.springcooler.sgma.studyschedule.common.exception;
...
@RestControllerAdvice(basePackages = "com.springcooler.sgma.studyschedule")
public class StudyScheduleExceptionHandler {
