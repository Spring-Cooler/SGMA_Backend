package com.springcooler.sgma.studyscheduleparticipant.common.exception;
...
@RestControllerAdvice(basePackages = "com.springcooler.sgma.studyscheduleparticipant")
public class StudyScheduleParticipantExceptionHandler {
