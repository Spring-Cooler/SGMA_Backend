...
| ESTJ                                                                                                     | ISTP                                                                                                    | ESTP                                                                                                                        | INFJ                                                                                                              | ESTJ                                                                                                    | [팀 노션](https://amber-vise-de0.notion.site/3-_-1da69b5acbe84d79be8e57bbf7cd7cee)
...
| :--------------------------------------: | ------ |
|  김서현  | 모든 부분에 있어서 열정적으로 임해주셨고, 이러한 열정 덕분에 팀원들이 더욱 프로젝트에 임할 수 있었습니다. 그리고 새로운 아이디어나 의견 충돌시 여러가지 경우의 수를 생각하며, 의견을 제시해주어 원할하게 소통할 수 있었습니다. |
