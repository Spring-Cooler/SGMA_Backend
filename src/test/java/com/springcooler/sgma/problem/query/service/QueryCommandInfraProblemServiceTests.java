...
class ProblemServiceImplTests {
    ...
    void testFindAllProblems() {
        List<ProblemDTO> problems = queryProblemServiceImpl.findAllProblems();
    ...
    void testFindProblemsByScheduleId(long scheduleId) {
        List<ProblemDTO> problems = queryProblemServiceImpl.findProblemsByScheduleId(scheduleId);
        Assertions.assertNotNull(problems);
        problems.forEach(System.out::println);
    }
    ...
    void testFindProblemsByParticipantIdAndScheduleId(long participantId, long scheduleId) {
        List<ProblemDTO> problems = queryProblemServiceImpl.findProblemsByScheduleIdAndParticipantId(participantId, scheduleId);
    }
}