package com.springcooler.sgma.studygroupmember.common.exception;
...
@RestControllerAdvice(basePackages = "com.springcooler.sgma.studygroupmember")
public class StudyGroupMemberGlobalExceptionHandler {
