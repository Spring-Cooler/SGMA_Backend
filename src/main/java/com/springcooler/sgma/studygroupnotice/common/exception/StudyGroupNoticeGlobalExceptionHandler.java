package com.springcooler.sgma.studygroupnotice.common.exception;
...
@RestControllerAdvice(basePackages = "com.springcooler.sgma.studygroupnotice")
public class StudyGroupNoticeGlobalExceptionHandler {
